        ...
        #grid(
          ...
          [
            ...
            #grid(
              ...
              [
                 #if "address" in author [
                   #fa-icon("location-dot", fill: white) #h(0.5em) #author.address \
                 ]
                 #if "website" in author [
                   #fa-icon("globe", fill: white) #h(0.5em) #link(author.website)[#author.website] \
                 ]
                 #if "email" in author [
                   #fa-icon("envelope", fill: white) #h(0.5em) #link("mailto:" + author.email)[#author.email]
                 ]
              ],
              [
